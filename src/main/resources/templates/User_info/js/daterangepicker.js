...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['User_info/js/moment', 'templates/User_info/js/jquery'], function (moment, jquery) {
        ...
        if (!jQuery) {
            jQuery = require('User_info/js/jquery');
            if (!jQuery.fn) jQuery.fn = {};
        }
        var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require('User_info/js/moment');
